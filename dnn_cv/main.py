...
from DNN import dnn, ReLULayer, SoftmaxLossLayer

MNIST_DIR = "C:/Users/Dell/Desktop/Data/mnist_data"
...
class MLP(object):
    ...
    def build_model(self):  # 建立网络结构
        ...
        self.fc1 = dnn(self.input_size, self.hidden1)
        self.relu1 = ReLULayer()
        self.fc2 = dnn(self.hidden1, self.hidden2)  #
        self.relu2 = ReLULayer()  #
        self.fc3 = dnn(self.hidden2, self.out_classes)
...
def build_mnist_mlp(param_dir='weight.npy'):
    h1, h2, e = 32, 16, 10
    mlp = MLP(hidden1=h1, hidden2=h2, max_epoch=e)
    mlp.load_data()
    mlp.build_model()
    mlp.init_model()
    mlp.train()
